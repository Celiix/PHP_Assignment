...
<head>
  ...
  ________________________________________________ -->
    <meta charset="utf-8">
    <title>Sports Gear Website  </title>
...
<body>
    <header>
    <nav class="navbar navbar-expand-sm" style="justify-content: center;background-color: lightskyblue;">
        <a class="navbar-brand" href="#" style="color: black;font-weight: bold;">Sports Gear Website! 
		</a>
        <ul class="navbar-nav">
            <li class="nav-item">
